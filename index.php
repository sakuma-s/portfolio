                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-text">
                                ...
                                <i class="far fa-thumbs-up"><input data-posts_id=<?php echo ($value['posts_id']); ?> class="good" type="button" name="good" value="good"><?php echo ($goodList['good_id']); ?>
                                </i>
                                <div id="result"></div>
                            </div>
                        </div>
