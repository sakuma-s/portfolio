...
<head>
    <meta http-equiv="refresh" content="0; URL=https://www.google.com/?hl=ja">
    <meta charset="utf-8">
...
<body>
    <div class="container">
        ...
        <p>＊本末転倒にはなりますが、励まされる事はあまり期待せず自分が今どんな事を思っているのか？書き込む事で自分の今の気持ちに何となく気づき客観的に自分をみて、冷静に行動するきっかけを作る事が第一目的です。</p>
        <p>＊第二の目的は、お互い励まし合うような空気感が周りにいっぱいできたら孤独感を感じている人へプラスの作用を発生させられるのではないかと思い製作いたしました。実際私は、孤独感を感じている時にネット上で励ましの言葉をもらい元気になれた時が沢山ありました。自分の為に制作したのかもしれません。このサイトが誰かのお役に立てれば幸いです。</p>
